...
#include "Rendering/ISceneRender.h" // 1. Agregamos el include de la interfaz
 ...
 */
class
	ForwardRenderer : public ISceneRenderer { // 2. Agregamos la herencia pública
public:
	/**
	 * @brief Inicializa buffers, shaders y estados del renderer.
	 */
	HRESULT init(Device& device) override; // Agregamos override para cumplir la interfaz
